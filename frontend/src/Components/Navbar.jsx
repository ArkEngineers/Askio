  ...
  return (
    <>
      ...
      <div className="border-b z-10 bg-grey-9 fixed top-20 left-20 px-12 text-lg w-full flex gap-4 text-grey-2 border-grey-6">
        <Link to="/app/classa/notes"><h1 className={`${isActive('/notes') ? 'text-base-3 border-b-2 border-base-3' : 'text-grey-3 border-grey-3'} py-2`}>
          Notes
        </h1></Link>
        <Link to="/app/classa/askme"><h1 className={`${isActive('/askme') ? 'text-base-3 border-b-2 border-base-3' : 'text-grey-3 border-grey-3'} py-2`}>
          AskMe
        </h1></Link>
      </div>
    </>
